...
[🚀 Live Demo](https://criminalid-facerecognition.streamlit.app) • [📓 Training Notebook](notebooks/Criminal_Face_Recognition_Using_Transfer_Learning.ipynb) • [📊 Dataset Notebook](notebooks/Dataset_Creation.ipynb)
